...
const CalendarComponent = (props) => {
  ...
  const confirmChoice = () => {
    ...
    if (
      ...
      setError(
        "Error: input not changed. Enter integers in between 0 and 12 or 0 and 59."
      );
      console.log(
        "Error: input not changed. Enter integers in between 0 and 12 or 0 and 59."
      );
      ...
      if (
        ...
        setError(
          "Error: invalid timespan. Enter times in chronological order."
        );
        console.log(
          "Error: invalid timespan. Enter times in chronological order."
        );
                ...
                if (
                  ...
                  for (var i = 0; i < values.length; i++) {
                    ...
                    if (Number(values[i]) === parseInt(Number(values[i]), 10)) {
                      if (
                        (i % 3 === 0 && (values[i] < 1 || values[i] > 12)) ||
                        (i % 3 !== 0 && (values[i] < 0 || values[i] > 59))
                      ) {
                        setError(
                          "Error: input is out of bounds. Enter integers in between 1 and 12 or 0 and 59."
                        );
                        console.log(
                          "Error: input is out of bounds. Enter integers in between 1 and 12 or 0 and 59."
                        );
  ...
  return (
    <div>
      ...
      <div>&nbsp;</div>
      <div className="donk">
        <h5>Click on a date twice or select a range of dates.</h5>
      </div>
      <div>&nbsp;&nbsp;</div>
      <div className="donk">
        --------------------------------------------------------------------------------------------------
      ...
      <div>&nbsp;</div>
      <div className="donk">{outputError}</div>
    </div>
  );
};
